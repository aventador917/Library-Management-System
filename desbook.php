...
$sql = "select *,users.name as userName,transactions.id as transactionsId from transactions  join users  on users.id=transactions.user_id  order by transactions.create_at DESC ";
